public class AK_42_Constructors {
    String color;
    float price;
    float maxSpeed;
    float currentFuel;
...
//    AK_42_Constructors() {     // Default constructor
//        color = "Black";
//        price = 500000;
//        maxSpeed = 180;
//        currentFuel = 2;
...
//    }
    ...
    AK_42_Constructors(String color) {   // Parameterized constructor
//        color = color;        // color -> inside parameter
    ...
    public static void main(String[] args) {
        AK_42_Constructors alto = new AK_42_Constructors();
        ...
        AK_42_Constructors swift = new AK_42_Constructors("Red");
