...
public class AK_17_MathPracticeSet1 {
    int roll() {
    ...
    public static void main(String[] args) {
        ...
        AK_17_MathPracticeSet1 dice = new AK_17_MathPracticeSet1();
        for(int i=0; i<10; i++) {
        ...
        AK_17_MathPracticeSet1 game = new AK_17_MathPracticeSet1();
        int num;
        int result;
        do {
